...
(function () {
  ...
  VK.audio = {
    ...
    tick() { tone(1200, 1500, 0.03, "square", 0.03); },
    forge() { [330, 415, 494, 659].forEach((f, i) => tone(f, f, 0.12, "triangle", 0.1, i * 0.05)); noise(0.2, 0.06, 0.15, 3000); },
    perk() { [523, 784, 1047].forEach((f, i) => tone(f, f * 1.01, 0.16, "square", 0.09, i * 0.08)); tone(262, 523, 0.3, "sine", 0.08, 0, "lin"); },
    clang() { tone(1400, 700, 0.08, "square", 0.07); noise(0.06, 0.08, 0, 4000, 2); },
    blink() { tone(1800, 600, 0.06, "sine", 0.05); },
    zap() { tone(2400, 300, 0.07, "sawtooth", 0.06); noise(0.04, 0.05, 0, 6000); },
